...
Purpose:
    Developing a predictive model able to predict whether a character in GOT
    is dead or alive.
...
got_raw = got_raw.replace(["Andals"], "Andal")
got_raw = got_raw.replace(["Asshai'i"], "Asshai")
got_raw = got_raw.replace(["Astapori"], "Astapor")
got_raw = got_raw.replace(["Braavosi"], "Braavos")
got_raw = got_raw.replace(["Dornishmen",
                           "Dorne"], "Dornish")
got_raw = got_raw.replace(["free folk",
                           "Free folk",
                           "free Folk",
                           "Free folk",
                           "Wildling",
                           "Wildlings",
                           "First men"], "Free_Folk")
got_raw = got_raw.replace(["Ghiscaricari"], "Ghiscari")
got_raw = got_raw.replace(["Ironmen", "ironborn"], "Ironborn")
got_raw = got_raw.replace(["Lhazarene"], "Lhazareen")
got_raw = got_raw.replace(["Lyseni"], "Lysene")
got_raw = got_raw.replace(["Meereenese"], "Meereen")
got_raw = got_raw.replace(["Northern mountain clans",
                           "northmen"], "Northmen")
got_raw = got_raw.replace(["Norvos"], "Norvoshi")
got_raw = got_raw.replace(["Qarth"], "Qartheen")
got_raw = got_raw.replace(["Reachmen"], "Reach")
got_raw = got_raw.replace(["Rivermen"], "Riverlands")
got_raw = got_raw.replace(["Stormlands"], "Stormlander")
got_raw = got_raw.replace(["Summer Islands",
                           "Summer Isles"], "Summer_Islander")
got_raw = got_raw.replace(["Vale mountain clans",
                           "Valemen"], "Vale")
got_raw = got_raw.replace(["Westerlands",
                           "westermen",
                           "Westermen"], "Westerman")
...
# Crownlands
got_raw = got_raw.replace(["House Baratheon",
                           ...
                           "House Longwaters",
                           "House Blackfyre",
                           "House Darklyn"], "House_Crownlands")


# North
got_raw = got_raw.replace(["House Stark",
                           "House Ashwood",
                           "House Bole",
                           "House Bolton",
                           "House Branch",
                           ...
                           "House Ryder",
                           "House Towers",
                           "House Woodfoot"], "House_North")


# Vale
got_raw = got_raw.replace(["House Arryn of the Eyrie",
                           "House Arryn",
                           "House Baelish",
                           "House Belmore",
                           "House Breakstone",
                           ...
                           "House Extinct Houses",
                           "House Shell",
                           "House Brightstone"], "House_Vale")


# Riverlands
got_raw = got_raw.replace(["House Tully",
                           "House Bigglestone",
                           "House Blackwood",
                           "House Blanetree",
                           "House Bracken",
                           ...
                           "House Qoherys",
                           "House Teague",
                           "House Towers of Harrenhal" ], "House_Riverlands")


# Westerlands
got_raw = got_raw.replace(["House Lannister of Casterly Rock",
                           "House Algood",
                           "House Banefort",
                           "House Bettley",
                           "House Brax",
                           ...
                           "House Garner",
                           "House Hamell",
                           "House Hawthorne Jast Kenning of Kayce Kyndall",
                           ...
                           "House Parren",
                           "House Reyne",
                           "House Tarbeck" ], "House_Westerlands")


# Iron Islands
got_raw = got_raw.replace(["House Greyjoy",
                           "House Blacktyde",
                           "House Botley",
                           "House Drumm",
                           "House Harlaw",
                           ...
                           "House Goodbrother of Corpse",
                           "House Goodbrother",
                           "House Lake",
                           "House Goodbrother of Crow",
                           "House Spike"
                           "House Keep",
                           ...
                           "House Weaver",
                           "House Greyiron",
                           "House Hoare"], "House_Iron_Islands")


# Reach
got_raw = got_raw.replace(["House Tyrell",
                           "House Ambrose",
                           "House Appleton",
                           "House Ashford",
                           "House Beesbury",
                           ...
                           "House Manderly",
                           "House Gardener",
                           "House Osgrey of Leafy Lake"], "House_Reach")


# Dorne
got_raw = got_raw.replace(["House Martell",
                           "House Allyrion",
                           "House Blackmont",
...
got_raw = got_raw.replace(["House Baratheon",
                           ...
                           "House Cole",
                           "House Durrandon",
                           "House Toyne"], "House_Stormlands")


# change the name of nights watch to avoid the '
got_raw = got_raw.replace(["Night's Watch" ], "Nights_Watch")
